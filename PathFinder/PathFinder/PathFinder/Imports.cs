...
namespace PathFinder
{
    public partial class FFXINAV
    {
        ...
        [DllImport("FFXINAV.dll", EntryPoint = "FindPathToPosi", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.LPStr)]
        public static extern void findPathToPosi(position_t start, position_t end);
